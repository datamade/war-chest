...
update candidate set current_office_holder=1, pupa_id = "ocd-person/946bcfe0-3cec-11e3-8a24-22000a971dca" where name = "Ricardo Munoz";
update candidate set current_office_holder=1, pupa_id = "ocd-person/9469481a-3cec-11e3-8a24-22000a971dca" where name = "Margaret Laurino";
update candidate set current_office_holder=1, pupa_id = "ocd-person/946c2dc8-3cec-11e3-8a24-22000a971dca" where name = "Walter Burnett, Jr";
update candidate set current_office_holder=1, pupa_id = "ocd-person/946cc828-3cec-11e3-8a24-22000a971dca" where name = "Michael Chandler";
update candidate set current_office_holder=1, pupa_id = "ocd-person/9469a418-3cec-11e3-8a24-22000a971dca" where name = "Michael R Zalewski";
update candidate set current_office_holder=1, pupa_id = "ocd-person/946926a0-3cec-11e3-8a24-22000a971dca" where name = "Carrie M Austin";
update candidate set current_office_holder=1, pupa_id = "ocd-person/946ce84e-3cec-11e3-8a24-22000a971dca" where name = "Daniel S Solis";
update candidate set current_office_holder=1, pupa_id = "ocd-person/946bb0e6-3cec-11e3-8a24-22000a971dca" where name = "Rey Colon";
update candidate set current_office_holder=1, pupa_id = "ocd-person/946b7356-3cec-11e3-8a24-22000a971dca" where name = "John A Pope";
update candidate set current_office_holder=1, pupa_id = "ocd-person/946ada68-3cec-11e3-8a24-22000a971dca" where name = "Anthony Beale";
update candidate set current_office_holder=1, pupa_id = "ocd-person/9468c840-3cec-11e3-8a24-22000a971dca" where name = "James A Balcer";
update candidate set current_office_holder=1, pupa_id = "ocd-person/a6728a4c-3f6e-11e3-8ca6-22000a971dca" where name = "Lona Lane";
update candidate set current_office_holder=1, pupa_id = "ocd-person/9469c362-3cec-11e3-8a24-22000a971dca" where name = "Howard B Brookins, Jr";
update candidate set current_office_holder=1, pupa_id = "ocd-person/94698564-3cec-11e3-8a24-22000a971dca" where name = "Leslie A Hairston";
update candidate set current_office_holder=1, pupa_id = "ocd-person/a67c3a10-3f6e-11e3-8ca6-22000a971dca" where name = "Emma Mitts";
update candidate set current_office_holder=1, pupa_id = "ocd-person/946847c6-3cec-11e3-8a24-22000a971dca" where name = "Latasha Thomas";
update candidate set current_office_holder=1, pupa_id = "ocd-person/a7d453e2-3d8a-11e3-b572-22000a971dca" where name = "JoAnn Thompson";
...
update candidate set current_office_holder=1, pupa_id = "ocd-person/946a3e32-3cec-11e3-8a24-22000a971dca" where name = "Willie B Cochran";
update candidate set current_office_holder=1, pupa_id = "ocd-person/94670fdc-3cec-11e3-8a24-22000a971dca" where name = "Scott Waguespack";
update candidate set current_office_holder=1, pupa_id = "ocd-person/9467cbf2-3cec-11e3-8a24-22000a971dca" where name = "Michelle A Harris";
update candidate set current_office_holder=1, pupa_id = "ocd-person/9468a810-3cec-11e3-8a24-22000a971dca" where name = "Natashia Holmes";
...
update candidate set current_office_holder=1, pupa_id = "ocd-person/946b365c-3cec-11e3-8a24-22000a971dca" where name = "Roderick T Sawyer";
...
update candidate set current_office_holder=1, pupa_id = "ocd-person/d30cec7e-3f81-11e3-9c4b-22000a971dca" where name = "Bob Fioretti";
update candidate set current_office_holder=1, pupa_id = "ocd-person/09e165b0-3f85-11e3-b895-22000a971dca" where name = "Will Burns";
